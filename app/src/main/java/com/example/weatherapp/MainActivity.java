...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView cityNameTV, temperatureTV, conditionTV,WindTV,HumTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MainActivity.this,new String[]
                    {android.Manifest.permission.ACCESS_FINE_LOCATION ,android.Manifest.permission.ACCESS_COARSE_LOCATION},PERMISSION_CODE);
   ...
   private String getCityName(double longitude, double latitude){
    ...
    private void getWeatherInfo(String cityName) {
        String url = "http://api.weatherapi.com/v1/forecast.json?key=9d73c2920ff041ceafc14308231206&q="+ cityName + "&days=1&aqi=yes&alerts=yes";
        cityNameTV.setText(cityName);
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(isDay==1){
                        Picasso.get().load("https://www.pexels.com/photo/blue-and-white-sky-with-stars-4737484").into(backIV);
                    }else {
                        Picasso.get().load("https://www.pexels.com/photo/starry-sky-over-mountains-2469122").into(backIV);
                    }
